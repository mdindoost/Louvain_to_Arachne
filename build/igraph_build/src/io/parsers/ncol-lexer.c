...
#define EOB_ACT_LAST_MATCH 2
     ...
     *       existing scanners that call yyless() from OUTSIDE igraph_ncol_yylex. 
...
void igraph_ncol_yyset_in  (FILE * _in_str ,yyscan_t yyscanner );

FILE *igraph_ncol_yyget_out (yyscan_t yyscanner );

void igraph_ncol_yyset_out  (FILE * _out_str ,yyscan_t yyscanner );
...
void igraph_ncol_yyset_lineno (int _line_number ,yyscan_t yyscanner );

int igraph_ncol_yyget_column  (yyscan_t yyscanner );

void igraph_ncol_yyset_column (int _column_no ,yyscan_t yyscanner );
...
static int yy_get_next_buffer (yyscan_t yyscanner)
{
		...
		while ( num_to_read <= 0 )
			...
			if ( b->yy_is_our_buffer )
				...
				b->yy_ch_buf = (char *)
					...
					igraph_ncol_yyrealloc((void *) b->yy_ch_buf,(yy_size_t) (b->yy_buf_size + 2) ,yyscanner );
				}
			else
	...
	if ((int) (yyg->yy_n_chars + number_to_move) > YY_CURRENT_BUFFER_LVALUE->yy_buf_size) {
		...
		YY_CURRENT_BUFFER_LVALUE->yy_ch_buf = (char *) igraph_ncol_yyrealloc((void *) YY_CURRENT_BUFFER_LVALUE->yy_ch_buf,(yy_size_t) new_size ,yyscanner );
    ...
    YY_BUFFER_STATE igraph_ncol_yy_create_buffer  (FILE * file, int  size , yyscan_t yyscanner)
{
	 ...
	 */
	b->yy_ch_buf = (char *) igraph_ncol_yyalloc((yy_size_t) (b->yy_buf_size + 2) ,yyscanner );
	if ( ! b->yy_ch_buf )
		YY_FATAL_ERROR( "out of dynamic memory in igraph_ncol_yy_create_buffer()" );
...
YY_BUFFER_STATE igraph_ncol_yy_scan_string (yyconst char * yystr , yyscan_t yyscanner)
{
	...
	return igraph_ncol_yy_scan_bytes(yystr,(int) strlen(yystr) ,yyscanner);
}
...
void igraph_ncol_yyset_debug (int  _bdebug , yyscan_t yyscanner)
{
    struct yyguts_t * yyg = (struct yyguts_t*)yyscanner;
